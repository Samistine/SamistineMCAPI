 ...
 *
 * The command
 * <pre>/example a letter b number c something</pre> is an example of a
 * situation where this could be useful.
 *
 * The keys are not case sensitive, but the values are. Any arguments that do
 * not match the format are discarded.
 *
 * @author Jacek Kuzemczak
 */
public final class PairArgumentProcessor extends ArgumentProcessor {
